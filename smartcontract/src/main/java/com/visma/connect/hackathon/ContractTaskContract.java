...
@Contract(name = "ContractTaskContract",
        info = @Info(title = "ContractTask contract", description = "My Smart Contract", version = "0.0.1", license = @License(name = "Apache-2.0", url = ""),
...
public class ContractTaskContract implements ContractInterface {
    ...
    @Transaction()
    public void createContractTask(Context ctx, String contractTaskId, String creationDate, String description, String dueDate, String contractorId,
    ...
    private void save(Context ctx, String contractTaskId, String creationDate, String description, String dueDate, String contractorId, String meterId,
            String status, String type, String verifierId) {
    ...
    @Transaction()
    public void updateContractTask(Context ctx, String contractTaskId, String creationDate, String description, String dueDate, String contractorId,
            String meterId, String status, String type, String verifierId) {
        boolean exists = contractTaskExists(ctx, contractTaskId);
        if (!exists) {
            throw new RuntimeException("The asset " + contractTaskId + " does not exist");
